...
const BlogHeroSection: React.FC = () => {
	...
	return (
		<section className="flex flex-col gap-4 py-4 pt-20 md:pt-24 px-4 sm:px-8 md:px-20 max-w-4xl mx-auto">
			<p className="text-lg text-center font-normal max-w-2xl mx-auto">
				Welcome to my blog where I rant on about software development, AI,
				career, philosophy, and my occasional existential crises.
			</p>
