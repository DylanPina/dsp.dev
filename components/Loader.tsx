...
const Loader: React.FC<Props> = ({ children }) => {
  ...
  return (
    <div ref={loadingRef} aria-hidden="true">
      <div className="white-bg fixed inset-0 dark:bg-secondary-black z-[9999] flex justify-center items-center">
        <div className="overflow-hidden">
          <span
            className="loading-text inline-block text-text text-4xl sm:text-5xl lg:text-7xl tracking-widest"
            style={{ opacity: 0 }}
          >
            {children}
          </span>
